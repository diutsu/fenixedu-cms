    ...
    <div class="panel-body">
            <form class="form-horizontal" action="${pageContext.request.contextPath}/cms/builders/${builder.slug}" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="slug" class="form-control" id="slug" value="${builder.slug}">
                                    ...
                                    <c:forEach items="${roles}" var="role">
                                        <div class="col-sm-3">
                                            <label for="roles-${role.name.content}">
                                                <input type="checkbox" name="roles" value="${role.externalId}" ${builder.roleTemplate.contains(role) ? 'checked' : ''}>
                                                    ${role.name.content}
                                            </label>
                                        </div>
                                    </c:forEach>
